...
class MultiAgentIoTEnvLatencyEnergySum(gym.Env):
    ...
    *** Device-Specific Power Model ***
    ...
    def _assign_device_powers(self) -> None:
        ...
        """
        self.capacitance_activity_factor = 1e-4  # kappa = C * A
        for d in getattr(self.resource_manager, "devices", {}).values():
    ...
    def step(self, actions: Dict[int, int]):
        ...
        for aid in agent_ids:
            ...
            infos[aid] = {
                ...
                "P_comp_effective": float((getattr(dev, "power_comp", 0.0) * (dvfs_ratio**3))),
                "P_comm_effective": float(getattr(dev, "power_comm", 0.0)),
