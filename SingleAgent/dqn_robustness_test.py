...
def robustness_comparison_dqn():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_DIR, "dqn_robustness_comparison.png"))
    ...
    # Save results as npy for future comparison
    np.save(os.path.join(RESULTS_DIR, "dqn_robustness_results.npy"), results)
