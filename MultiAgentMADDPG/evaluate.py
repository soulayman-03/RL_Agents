...
# Allow running both:
# - as a module:  python -m MultiAgentMADDPG.evaluate
# - as a script:  python MultiAgentMADDPG/evaluate.py
if __package__:
...
def evaluate(episodes: int = 50):
    ...
    base = os.path.join(SCRIPT_DIR, "models", "maddpg")

    env0 = MultiAgentIoTEnv(
    ...
    obs_dim = int(env0.single_state_dim)
    env0.close() if hasattr(env0, "close") else None
