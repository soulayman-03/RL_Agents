...
if __package__:
    ...
    from MultiAgentMADDPG_LatencyEnergySum.manager import MADDPGManager
    from MultiAgentMADDPG_LatencyEnergySum.environment import MultiAgentIoTEnvLatencyEnergySum
    from MultiAgentMADDPG_LatencyEnergySum.plots import (
        EvalEpisodeFlow,
        plot_actor_critic_losses,
        plot_avg_cumulative_rewards,
        plot_execution_flow,
...
def train(
    *,
    ...
    RESULTS_DIR = os.path.join(SCRIPT_DIR, "results", scenario)
