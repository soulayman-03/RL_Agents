...
# Allow running both:
# - as a module:  python -m MultiAgentQMIX.train
# - as a script:  python MultiAgentQMIX/train.py
if __package__:
    from .environment import MultiAgentIoTEnv
    from .manager import QMIXManager
    from .plots import plot_training_trends, plot_per_agent_training_rewards
else:
    PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    if PROJECT_ROOT not in sys.path:
        sys.path.insert(0, PROJECT_ROOT)
    from MultiAgentQMIX.environment import MultiAgentIoTEnv
    from MultiAgentQMIX.manager import QMIXManager
    from MultiAgentQMIX.plots import plot_training_trends, plot_per_agent_training_rewards
...
def train():
    ...
    print(f"Starting QMIX Multi-Agent Training with {NUM_AGENTS} agents...")
    ...
    base = os.path.join(SAVE_DIR, "qmix")
    manager.save(base)
    ...
    print(
        ...
        f"  Models: {base}_agent_*.pt and {base}_mixer.pt\n"
