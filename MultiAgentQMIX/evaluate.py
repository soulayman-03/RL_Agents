...
# Allow running both:
# - as a module:  python -m MultiAgentQMIX.evaluate
# - as a script:  python MultiAgentQMIX/evaluate.py
if __package__:
    ...
    from MultiAgentQMIX.plots import (
        EvalEpisodeFlow,
        plot_evaluation_summary,
        plot_execution_flow,
        plot_marl_eval_summary,
...
def evaluate(episodes: int = 50):
    ...
    base = os.path.join(SCRIPT_DIR, "models", "qmix")
