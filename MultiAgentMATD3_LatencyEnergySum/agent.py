...
from .networks import CentralizedCritic, DiscreteActor
...
class MATD3Agent:
    def __init__(
        ...
        # Twin critics
        self.critic1 = CentralizedCritic(self.state_dim, self.joint_action_dim).to(self.device)
        self.critic2 = CentralizedCritic(self.state_dim, self.joint_action_dim).to(self.device)
        self.target_critic1 = CentralizedCritic(self.state_dim, self.joint_action_dim).to(self.device)
        self.target_critic2 = CentralizedCritic(self.state_dim, self.joint_action_dim).to(self.device)
        ...
        self.critic1_opt = torch.optim.Adam(self.critic1.parameters(), lr=float(critic_lr))
        self.critic2_opt = torch.optim.Adam(self.critic2.parameters(), lr=float(critic_lr))
