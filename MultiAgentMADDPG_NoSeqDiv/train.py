...
def train(
    *,
    ...
    eps_min: float = 0.01,
    sequential_diversity: bool = False,
):
    NUM_AGENTS = 10
    NUM_DEVICES = 15
    ...
    env = MultiAgentIoTEnvLatencyEnergySum(
        ...
        sequential_diversity=bool(sequential_diversity),
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--no-sequential-diversity", action="store_true", default=True, help="Set to True to disable sequential diversity check (default True for this folder)")
    ...
    train(
            ...
            sequential_diversity=not bool(args.no_sequential_diversity),
    )
